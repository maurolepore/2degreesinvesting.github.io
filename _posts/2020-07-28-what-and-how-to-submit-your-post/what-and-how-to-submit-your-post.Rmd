...
`distill::create_post()` gives you a template you can then modify. As a reference, here is the yaml header of this post:
...
As far as the world can tell, your work or idea does not exist unless it's published somewhere. Get stuff out. The technical details don't matter (we'll help you with that); what matters is your idea -- share it early, share it often. 
