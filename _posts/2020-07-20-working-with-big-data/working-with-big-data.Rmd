...
```{r}
lbk <- vroom::vroom("~/Downloads/tmp/lbk-20mb.csv")
lbk <- dplyr::slice_sample(lbk, n = 4000)

ald <- vroom::vroom("~/Downloads/tmp/ald-100mb.csv")
ald <- dplyr::slice_sample(ald, n = 4000)
```
...
benchmark <- bench::mark(
  check = FALSE,
  iterations = 10,
  small_lbk  = match_name(lbk[lbk_crucial], ald),
  small_ald  = match_name(lbk,              ald[ald_crucial]),
  full_both  = match_name(lbk,              ald)
)
